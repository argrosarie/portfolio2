...
function BackgroundCircles({}: Props) {
  return (
    ...
    className='relative flex justify-center items-center md:mt-32'>
        ...
        <div className='absolute border border-[#5dc1b9] rounded-full h-[500px] w-[500px] mt-52 animate-pulse'/>
        <div className='absolute border border-[#333] rounded-full opacity-20 h-[650px] w-[650px] mt-52 '/>
