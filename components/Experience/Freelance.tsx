  ...
  return (
    <article className="h-max md:pb-10 flex flex-col rounded-lg items-center space-y-4 flex-shrink-0 w-[260px] md:w-[700px] px-4 py-6  bg-[#292929] hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden">
      ...
      <ul className="list-disc space-y-2 ml-5 text-lg text-start">
        <li>
          Understanding client requirements and translating them into technical
          specifications
        </li>
        <li>
          Keeping up-to-date with latest front-end technologies, tools and best
          practices
        </li>
        <li>
          Communicating with clients, providing regular updates, and ensuring
          their satisfaction with the work
        </li>
        <li>
          Managing project timelines, budgets, and deadlines to deliver projects
